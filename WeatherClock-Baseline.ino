...
const int timeZone = -4;  // Eastern Standard Time (USA)  set your own time offset 

int nixieBulbDelayTime = 500;
int ledFadeTime = 8;

/* 
Change the values below to match region and Wifi information. Go to http://www.openweather.org/   *  
 */
String ZIPCODE = "60601";     // Your US Zipcode here 
String APPID = "**33**16**59**70**af**73**";  // Get your APP ID FROM openweather.org

char ssid[] = "**YOURSSIDHERE**";    // SSID name here
char pass[] = "**YOURWIFIPASSWORDHERE**"; // WIFI PASSWORD HERE
char host[] = "api.openweathermap.org";  // Set up for this service. 


// New NixieKeith PCB settings
int GEIGER_PIN = 15;
int GEIGER_LED = 5;
